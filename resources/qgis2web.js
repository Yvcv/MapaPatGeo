...
map.getView().fit([-11140593.624841, 2324453.866392, -11105552.871892, 2357133.761628], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAPA DE GEODIVERSIDAD</h2>';
        return titleElement;
    })(),
